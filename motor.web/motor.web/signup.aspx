<%@ Page Title="" Language="C#" MasterPageFile="~/motorpublic.Master" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="motor.web.signup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <table width="60%">
        ...
        <tr>
            <td>
                <asp:Label Text="Middle:" ID="lblMiddlename" runat="server" /></td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label Text="How did you hear about us:" ID="lblSource" runat="server" />
            </td>
            <td>
                <asp:DropDownList runat="server" ID="ddlSource">
                    <asp:ListItem Text="Friend" />
                    <asp:ListItem Text="Internet" />
                    <asp:ListItem Text="Megazine" />
